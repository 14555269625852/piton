...
class OnlineShop:
    ...
    def __init__(self, driver):
        self._driver = driver
        self._driver.get(Magazin_URL)
        self._driver.implicitly_wait(4)
        self._driver.maximize_window()

    @allure.step("Авторизация на сайт")
    ...
    @allure.step("Получить информацию о наименованиях товаров, их ценах и кнопка Добавить в корзину")
    ...
    @allure.step("Сравнить переданное наименование товаров с товарами на сайте, совпадающие добавляем в корзину")
    def add_items_to_cart(self, name_item1: str,
                          name_item2: str, name_item3: str):
        item1_button = None
        item2_button = None
        item3_button = None
    ...
    @allure.step("Перейти в корзину, оформить заказ, вносим контактные данные в необходимые поля")
    ...
    @allure.step("Получить итоговую стоимость товаров с сайта")
